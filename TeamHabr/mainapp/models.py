...
class CategoryPost(models.Model):
    ...
    slug = models.SlugField(allow_unicode=True, max_length=64, editable=False, unique=True)
...
class Post(models.Model):
    ...
    status_update = models.DateTimeField(verbose_name='Дата обновления статуса', default=datetime.datetime.today)
    date_create = models.DateTimeField(verbose_name='Дата создания статьи', default=datetime.datetime.today)
    date_update = models.DateTimeField(verbose_name='Дата изменения статьи', default=datetime.datetime.today)
    ...
    def get_absolute_url(self):
        return reverse("post", kwargs={"slug": self.slug, "category_slug": self.category_id.name})
...
class Comment(models.Model):
    ...
    date_create = models.DateTimeField(verbose_name='Дата создания комментария', default=datetime.datetime.today)
    date_update = models.DateTimeField(verbose_name='Дата изменения комментария', default=datetime.datetime.today)
