"""
Django settings for TeamHabr project.
...
WSGI_APPLICATION = 'TeamHabr.wsgi.application'
...
if 'test' in sys.argv:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'eTcilopp$agile_db',
            'USER': 'eTcilopp',
            'PASSWORD': 'uM1ecmJai8DV',
            'HOST': 'eTcilopp.mysql.pythonanywhere-services.com',
            # 'PORT': '5432',
        }
    }
